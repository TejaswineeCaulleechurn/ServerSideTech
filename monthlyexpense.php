...
<head>
	...
	<title>MoneyManager - Monthly Expense Report</title>
	...
	<!-- bootstrap class to generate the panel for expense list -->
		<div class="col-10 col-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			...
			<!-- panel heading to indicate the purpose of the page -->
				<div class="panel-heading loginpanel_heading h4" align="center">Monthly Expense Report</div>
				<!-- panel body to contain the contents of the page -->
					...
					.		<?php
							...
							?>
							<!-- list header -->
							<h5 align="center" style="color:blue">Monthwise Expense Report from <?php echo $monthdate?> to <?php echo $currentdate?></h5>
							<hr />
